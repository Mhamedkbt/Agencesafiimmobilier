  ...
  const contactInfo = [
    {
      ...
      label: t('phone'),
      links: [
        { text: tFooter('phone_primary'), href: 'tel:+212600716145' },
        // { text: tFooter('phone_secondary'), href: 'tel:+212600716145' },
      ],
    },
    {
      icon: (
    ...
    <div>
      ...
      <section className="w-full max-w-full bg-white px-4 py-12 sm:px-6 lg:px-8 lg:py-16 box-border overflow-x-hidden">
        <div className="mx-auto grid w-full max-w-7xl gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#121212] sm:text-3xl">{t('get_in_touch')}</h2>
            <div className="mt-2 h-1 w-16 rounded-full bg-[#D4AF37]" />
            ...
            <div className="mt-8 space-y-4">
              ...
              <a href="https://wa.me/212600716145" target="_blank" rel="noopener noreferrer" className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#25D366] px-6 py-4 text-base font-semibold text-white shadow-md transition-colors hover:bg-[#20bd5a]">
