...
const socialLinks = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/profile.php?id=100092886537847#/",
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/appartsimo/",
    icon: (
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          <div>
            <Link href={`/${locale}`} className="inline-block">
              <img src="/images/logoImg.png" className="h-18 w-auto" alt="Appartsimo" />
            </Link>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-gray-300">
              ...
              <li>
                <a
                  href="mailto:luxurioussuiteshotel@gmail.com"
                  className="transition-colors hover:text-[#C9A55A]"
                >
                  {t("email")}
                </a>
