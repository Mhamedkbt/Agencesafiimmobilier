  ...
  return (
    <section className="bg-gray-50 px-4 py-17 sm:px-6 lg:px-8 overflow-hidden border-t border-gray-100 w-full">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <h2 className="mt-2 text-3xl font-bold tracking-tight text-[#121212] sm:text-4xl">
          {t("title")}
        </h2>
        ...
        <div className="relative mt-12 min-h-[220px] flex items-center justify-center">
          {testimonialsData.map((testimonial, idx) => (
            ...
            >
              ...
              <p className="text-xl sm:text-2xl text-[#121212] font-light max-w-2xl leading-relaxed italic">
                &ldquo;{testimonial.text}&rdquo;
              </p>

              <h4 className="mt-6 text-base font-bold text-[#121212] tracking-wide">
                {testimonial.name}
              </h4>
        ...
        <div className="mt-8 flex justify-center gap-2.5">
          {testimonialsData.map((_, idx) => (
            <button
              ...
              className={`h-2 rounded-full transition-all duration-300 ${idx === currentSlide ? "w-8 bg-[#D4AF37]" : "w-2 bg-gray-300 hover:bg-gray-400"
                }`}
