...
export default function PropertyPage() {
      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-white px-4">
        <div className="text-center">
          ...
          <Link
            ...
            className="mt-6 inline-block rounded-lg bg-[#D4AF37] px-8 py-3 font-semibold text-[#121212] hover:bg-[#D4B56A] transition-colors"
          >
            {t('browse_all')}
          </Link>
        </div>
  ...
  const propertyDetailsCardContent = (
    <>
      <p className="text-3xl font-bold text-[#D4AF37] sm:text-4xl">
        {property.price
      ...
      <ul className="mt-6 space-y-4">
        {[
          ...
          >
            ...
            <span className="text-sm font-semibold text-[#121212] capitalize">{detail.value}</span>
          </li>
        ))}
      </ul>

      <a
        href={`https://wa.me/212600716145?text=Hello, I'm interested in the property: ${encodeURIComponent(property.title ?? '')} - ${encodeURIComponent(`${process.env.NEXT_PUBLIC_APP_URL ?? 'https://Agencesafiimmobilier.vercel.app/'}/${locale}/properties/${property.id}`)}`}
        target="_blank"
    ...
    <>
      ...
      {formSent ? (
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div>
            <label htmlFor="name" className="mb-1.5 block text-sm font-medium text-[#121212]">
              {t('name')}
            </label>
            <input
              id="name"
              ...
              className="w-full rounded-lg border border-gray-200 px-4 py-2.5 text-sm text-[#121212] placeholder:text-gray-400 focus:border-[#D4AF37] focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/30"
            />
          </div>
          <div>
            <label htmlFor="phone" className="mb-1.5 block text-sm font-medium text-[#121212]">
              {t('phone')}
            </label>
            <input
              id="phone"
          ...
          <div>
            <label htmlFor="email" className="mb-1.5 block text-sm font-medium text-[#121212]">
              {t('email')}
            </label>
            <input
              id="email"
          ...
          <div>
            <label htmlFor="message" className="mb-1.5 block text-sm font-medium text-[#121212]">
              {t('message')}
            </label>
            <textarea
              id="message"
              ...
              className="w-full resize-none rounded-lg border border-gray-200 px-4 py-2.5 text-sm text-[#121212] placeholder:text-gray-400 focus:border-[#D4AF37] focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/30"
            />
          </div>
          <button
            type="submit"
            disabled={formSending}
            className="w-full rounded-lg bg-[#D4AF37] px-6 py-3 text-sm font-semibold text-[#121212] transition-colors hover:bg-[#D4B56A] focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:ring-offset-2 disabled:opacity-60 disabled:cursor-not-allowed"
          >
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 lg:grid-cols-3 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
                  ...
                  <div className="mt-4">
                    <div className="relative group">
                      ...
                      <button
                        ...
                        className="absolute left-0 top-1/2 -translate-y-1/2 z-20 bg-[#121212]/80 hover:bg-[#121212] text-white rounded-full p-2 transition-all opacity-0 group-hover:opacity-100 shadow-lg"
                      ...
                      >
                        {images.map((src, index) => (
                          <button
                            ...
                            className={`relative flex-shrink-0 w-24 h-20 sm:w-32 sm:h-24 overflow-hidden rounded-lg transition-all duration-200 cursor-pointer ${activeImage === index
                              ? 'border-2 border-[#D4AF37] opacity-100'
                      ...
                      <button
                        ...
                        className="absolute right-0 top-1/2 -translate-y-1/2 z-20 bg-[#121212]/80 hover:bg-[#121212] text-white rounded-full p-2 transition-all opacity-0 group-hover:opacity-100 shadow-lg"
            ...
            <div>
              ...
              <p className="whitespace-pre-line text-[#121212] leading-relaxed">
                  ...
                  {similarProperties.map((item) => (
                    ...
                    >
                      {item.images && item.images.length > 0 ? (
                        ...
                        <div className="h-40 w-full bg-gradient-to-br from-[#121212] to-[#121212] flex items-center justify-center">
                      ...
                      <div className="p-4">
                        {item.type && (
                          <span className="rounded-full bg-[#121212] px-2.5 py-0.5 text-xs font-medium text-white capitalize">
                            {item.type}
                          </span>
                        )}
                        <h3 className="mt-2 font-semibold text-[#121212] line-clamp-1">
                          {item.title ?? 'Property'}
                        </h3>
                        <p className="mt-1 text-sm text-gray-500">
                        ...
                        <Link
                          ...
                          className="mt-3 block w-full rounded-lg bg-[#D4AF37] py-2.5 text-center text-sm font-semibold text-[#121212] transition-colors hover:bg-[#D4B56A]"
                        >
                          {t('view_details')}
                        </Link>
                      </div>
            ...
            <div className="absolute bottom-5 left-1/2 -translate-x-1/2 flex gap-2 z-10">
              {images.map((url, index) => (
                <button
                  ...
                  className={`w-14 h-14 rounded-lg overflow-hidden border-2 transition-all duration-200 flex-shrink-0 ${index === lightboxIndex
